export const folderConfig = [
  ...
  {
    folderName: "src/common",
    desc: "This directory contains different folders based on the project.",
    link: [{ href: "sup-1", body: 1 }],
    subFolders: [
      {
